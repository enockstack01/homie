  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-foreground/50">The AI presentation operating system.</p>
      </div>
      ...
      {me.status === "pending" && (
        <div className="rounded-md border border-accent/50 bg-accent-soft/50 p-4 text-black/80">
          ...
          <p className="text-sm">{`Your account has been created, but ${approver} needs to approve it before AI-drafted decks will work. Templates below are free and available right now regardless.`}</p>
        </div>
      )}
